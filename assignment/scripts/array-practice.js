...
let favoriteFoods = ["pasta", "mango", "pho", "sushi", "ribs"];
...
//     log both the food removed and the updated array
let removeFood = favoriteFoods.shift();
console.log("Removed the first food", removeFood);
...
let splicedFood = favoriteFoods.splice(1, 1, "tacos");
console.log(favoriteFoods);
...
let joinedFoods = favoriteFoods.join(" and ");
...
let concatArray = favoriteFoods.concat(animalArray);
